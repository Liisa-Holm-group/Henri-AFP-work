...
do
    ...
    do
        python stacking_experiment.py $model $output_path $target_path $level3_data_path $level2_data_path $cluster_index_path $ontology $n_jobs $level3 $ranking $additional $taxonomy $pool
